...
- The model tell us that the estimate of 'x1' is `r summ_xy_mod$coefficients[2, 1]` and that it is not significantly different from 0 (p-value = `r summ_xy_mod$coefficients[2, 4]`)
