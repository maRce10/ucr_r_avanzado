...
subtitle: <center><font size="5"><b>Programación y métodos estadísticos avanzados en R</b></b> <br>Universidad de Costa</font></center>
...
- Ser capaz de documentar manejo/análisis de datos en R usando Rmarkdown
...
El compartir datos y análisis de forma transparente y detalladamente documentada, en formatos que puedan ser reproducidos por otros investigadores, ha sido sugerido como una de las principales herramientas para lidear con este problema.  
...
- El texto del informe está **escrito como texto normal**, por lo que no se requieren conocimientos de programación (i.e. R o HTML)
...
- **Se actualiza fácilmente** tanto para incluir nuevos análisis y/o integrar nuevos datos 
...
<font size="2"> <i>Nota: es posible que se le solicite aquí que instale varios paquetes necesarios para que R Markdown funcione.</i></font> 
...
[Esta guia](https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-spanish.pdf) sobre las opciones de los bloques de código puede ser muy útil:
...
[En este enlace](https://yihui.org/knitr/options/) se detallan todas los argumentos disponibles para personalizar los bloques de código. 
...
# instale estos paquetes primero
...
Tambien se puede incrustar en el texto como lo vimos en [mas arriba](#incrustar-código-de-r-en-el-texto) `r ji("up_arrow")` (`ji("up_arrow")`)
...
-  Reproduzca alguno de los ejemplos disponibles en el sitio del paquete dynagraphs ([https://rstudio.github.io/dygraphs/](https://rstudio.github.io/dygraphs/)) e incrustelo en su reporte dinámico  
...
- Genere un reporte dinámico en format PDF
