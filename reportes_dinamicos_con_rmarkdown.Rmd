...
La mayoría de los análisis de datos en estudios científicos no se pueden replicar. 
...
El compartir datos y análisis de forma transparente y detalladamente documentada, en formatos que puedan ser reproducidos por otros investigadores ha sido señalado como una de las principales herramientas para lidear con este problema.  
...
[Esta guia](https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-spanish.pdf) sobre las opciones de los 'chunks' puede ser muy útil:
...
... y este es el código (por si desea copiarlo):
