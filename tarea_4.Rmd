...
2. Utilice el paquete [DT](https://rstudio.github.io/DT/) para generar un cuadro (tabla) de los datos `iris`. Debe instalar y cargar el paquete primero. También recuerde usar la opción `results = "as.is"` en el encabezado del bloque de código. La tabla debe verse igual a esta:
